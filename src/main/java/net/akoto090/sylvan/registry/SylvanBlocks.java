...
import net.akoto090.sylvan.Sylvan;
import net.akoto090.sylvan.block.*;

import java.util.function.Supplier;

public class SylvanBlocks {
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, Sylvan.MOD_ID);
    ...
    public static final RegistryObject<Block> OAK_BRANCH = registerBlock("oak_branch", () -> new BranchBlock(Blocks.OAK_LOG, SylvanBlocks.FALLEN_OAK_LEAVES.get(), BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).noCollission().noOcclusion().strength(1.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> BIRCH_BRANCH = registerBlock("birch_branch", () -> new BranchBlock(Blocks.BIRCH_LOG, Sylvan.FALLEN_BIRCH_LEAVES.get(), BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).noCollission().noOcclusion().strength(1.0F).sound(SoundType.WOOD)));
    ...
    private static <T extends Block> RegistryObject<T> registerBlock(String name, Supplier<T> block) {
        RegistryObject<T> toReturn = SylvanBlocks.BLOCKS.register(name, block);
        SylvanItems.ITEMS.register(name, () -> new BlockItem(toReturn.get(), new Item.Properties().tab(Sylvan.TAB)));
        return toReturn;
    }
}
