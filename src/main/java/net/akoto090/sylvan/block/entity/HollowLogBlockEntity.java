package net.akoto090.sylvan.block.entity.

import net.akoto090.sylvan.registry.SylvanBlockEntityTypes;
...
public class HollowLogBlockEntity extends RandomizableContainerBlockEntity {
    ...
    public HollowLogBlockEntity(BlockPos pos, BlockState state) {
        super(SylvanBlockEntityTypes.HOLLOW_LOG.get(), pos, state);
    }
    ...
    protected Component getDefaultName() {
        return new TranslatableContents()("container.sylvan.hollow_log") {
        };
    }
